...
public class Base {
	...
	public Properties init_properties() {
		...
		try {
			FileInputStream inputStream = new FileInputStream("C:\\Users\\alam4\\eclipse-workspace\\KeyWordDrivenFB\\src\\main\\java\\com\\qa\\fb\\keyword\\config\\config.properties");
